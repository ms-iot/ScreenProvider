...
typedef struct _LUNICODE_STRING {
    __maybevalid SIZE_T Length;
    __maybevalid SIZE_T MaximumLength;
#if defined(MIDL_PASS)
    [size_is(MaximumLength / 2), length_is((Length) / 2) ] USHORT * Buffer;
#else // MIDL_PASS
    __field_bcount_part_opt(MaximumLength, Length) WCHAR *Buffer;
#endif // MIDL_PASS
} LUNICODE_STRING;
...
#else // MIDL_PASS
    __field_bcount_part_opt(MaximumLength, Length) UCHAR *Buffer;
#endif // MIDL_PASS
} LUTF8_STRING;
